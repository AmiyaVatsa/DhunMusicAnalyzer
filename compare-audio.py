...
def audio_comparator(file_1 : str, file_2 : str):
    ...
    print((mx - dtw[dtw.shape[0] - 1][dtw.shape[1] - 1]) / mx * 100, "%")
    ipd.Audio(data = audio_1, rate = sr)
    ipd.Audio(data = audio_2, rate = sr)

if __name__ == "__main__":
    filename_1 = input()
    filename_2 = input()
    audio_comparator(file_1=filename_1, file_2=filename_2)
